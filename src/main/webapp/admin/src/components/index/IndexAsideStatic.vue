<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"none"}' class="el-menu-vertical-demo" default-active="0">
				<el-image v-if="false" :style='{"margin":"10px auto","objectFit":"cover","borderRadius":"100%","background":"#f00","display":"block","width":"44px","height":"44px"}' src="http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg" fit="cover"></el-image>
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","background":"none","display":"none"}
