<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="方案编号" prop="fanganbianhao">
					<el-input v-model="ruleForm.fanganbianhao" placeholder="方案编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fanganbianhao" label="方案编号" prop="fanganbianhao">
					<el-input v-model="ruleForm.fanganbianhao" placeholder="方案编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="方案标题" prop="fanganbiaoti">
					<el-input v-model="ruleForm.fanganbiaoti" placeholder="方案标题" clearable  :readonly="ro.fanganbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="方案标题" prop="fanganbiaoti">
					<el-input v-model="ruleForm.fanganbiaoti" placeholder="方案标题" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="方案简介" prop="fanganjianjie">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="方案简介"
					  v-model="ruleForm.fanganjianjie" >
					</el-input>
				</el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='fanganbiaoti'){
							this.ruleForm.fanganbiaoti = obj[o];
							this.ro.fanganbiaoti = true;
							continue;
						}
						if(o=='fanganjianjie'){
							this.ruleForm.fanganjianjie = obj[o];
							this.ro.fanganjianjie = true;
							continue;
						}
						if(o=='fanganneirong'){
							this.ruleForm.fanganneirong = obj[o];
							this.ro.fanganneirong = true;
							continue;
						}
						if(o=='dengjishijian'){
	...
	this.ruleForm.fanganneirong = this.ruleForm.fanganneirong.replace(reg,'../../../ssmlyz86/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yingjiyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yingjiyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
