	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="驾照有效期" prop="jiazhaoyouxiaoqi">
					<el-input v-model="ruleForm.jiazhaoyouxiaoqi" placeholder="驾照有效期" clearable  :readonly="ro.jiazhaoyouxiaoqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="驾照有效期" prop="jiazhaoyouxiaoqi">
					<el-input v-model="ruleForm.jiazhaoyouxiaoqi" placeholder="驾照有效期" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiazhaoyouxiaoqi'){
							this.ruleForm.jiazhaoyouxiaoqi = obj[o];
							this.ro.jiazhaoyouxiaoqi = true;
							continue;
						}
				}
