	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="警报原因" prop="jingbaoyuanyin">
					<el-input v-model="ruleForm.jingbaoyuanyin" placeholder="警报原因" clearable  :readonly="ro.jingbaoyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="警报原因" prop="jingbaoyuanyin">
					<el-input v-model="ruleForm.jingbaoyuanyin" placeholder="警报原因" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="警报时间" prop="jingbaoshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.jingbaoshijian" 
						type="datetime"
						:readonly="ro.jingbaoshijian"
						placeholder="警报时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jingbaoshijian" label="警报时间" prop="jingbaoshijian">
					<el-input v-model="ruleForm.jingbaoshijian" placeholder="警报时间" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				biaoti : false,
				dianhua : false,
				jingbaoyuanyin : false,
				jingbaoshijian : false,
				zhanghao : false,
				xingming : false,
				sfsh : false,
				shhf : false,
	...
	created() {
		this.ruleForm.jingbaoshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jingbaoyuanyin'){
							this.ruleForm.jingbaoyuanyin = obj[o];
							this.ro.jingbaoyuanyin = true;
							continue;
						}
						if(o=='jingbaoshijian'){
							this.ruleForm.jingbaoshijian = obj[o];
							this.ro.jingbaoshijian = true;
							continue;
						}
						if(o=='zhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jingbaojiemian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jingbaojiemianCrossAddOrUpdateFlag = false;
						 this.parent.search();
