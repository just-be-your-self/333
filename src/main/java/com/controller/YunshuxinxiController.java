...
public class YunshuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YunshuxinxiEntity yunshuxinxi, 
		...
		if(tableName.equals("jiashiyuan")) {
			yunshuxinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R save(@RequestBody YunshuxinxiEntity yunshuxinxi, HttpServletRequest request){
    	yunshuxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R add(@RequestBody YunshuxinxiEntity yunshuxinxi, HttpServletRequest request){
    	yunshuxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(yunshuxinxi);
    	yunshuxinxi.setUserid((Long)request.getSession().getAttribute("userId"));
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YunshuxinxiEntity> wrapper = new EntityWrapper<YunshuxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yunshuxinxiService.selectCount(wrapper);
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yunshuxinxiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yunshuxinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yunshuxinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,YunshuxinxiEntity yunshuxinxi, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("jiashiyuan")) {
            yunshuxinxi.setZhanghao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<YunshuxinxiEntity> ew = new EntityWrapper<YunshuxinxiEntity>();
        int count = yunshuxinxiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yunshuxinxi), params), params));
